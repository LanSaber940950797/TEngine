...
namespace Kurisu.AkiBT
{
    ...
    public abstract class NodeBehavior
    {
        ...
        protected void InitSharedTObject<TObject>(SharedTObject<TObject> sharedVariable) where TObject : Object
        {
            InitVariable(sharedVariable);
            if (sharedVariable != null && sharedVariable.GetValue() == null)
            {
                var value = Activator.CreateInstance(typeof(TObject)) as TObject;
