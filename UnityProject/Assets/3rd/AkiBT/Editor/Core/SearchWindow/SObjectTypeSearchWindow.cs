...
{
    public class SObjectTypeSearchWindow : ScriptableObject, ISearchWindowProvider
    {
        ...
        List<SearchTreeEntry> ISearchWindowProvider.CreateSearchTree(SearchWindowContext context)
        {
            ...
            List<Type> nodeTypes = SubclassSearchUtility.FindSubClassTypes(typeof(ET.Entity));
            //nodeTypes.AddRange(SubclassSearchUtility.FindSubClassTypes(typeof(Sog.ECS.Component)));
