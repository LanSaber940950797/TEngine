    ...
    public class FieldResolverFactory
    {
        ...
        public IFieldResolver Create(FieldInfo fieldInfo)
        {
            ...
            if(fieldType == typeof(object))
                return new SObjectResolver(fieldInfo);
        ...
        public static bool IsSharedSTObject(Type type)
        {
            return type.IsGenericType && type.GetGenericTypeDefinition() == typeof(SharedSTObject<>);
        }
