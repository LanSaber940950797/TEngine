...
{
    [CustomEditor(typeof(BattleAITreeViewComponent),true)]
    public class BattleAITreeViewEditor : UnityEditor.Editor
    {
        ...
        private IBehaviorTree Tree
        {
            get
            {
                var t = target as BattleAITreeViewComponent;
                return t.treeSo;
            }
        }
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            {
                BattleAIEditorWindow.Show(Tree);
            });
