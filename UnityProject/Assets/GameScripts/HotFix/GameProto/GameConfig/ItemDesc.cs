...
{
public sealed partial class ItemDesc : Luban.BeanBase
{
    public ItemDesc(ByteBuf _buf) 
    {
        Id = _buf.ReadInt();
    ...
    public static ItemDesc DeserializeItemDesc(ByteBuf _buf)
    {
        return new ItemDesc(_buf);
    }
    ...
    public ItemDesc UpgradeToItemId_Ref;
    /// <summary>
    /// 过期时间
    /// </summary>
    ...
    public const int __ID__ = 1241682020;
