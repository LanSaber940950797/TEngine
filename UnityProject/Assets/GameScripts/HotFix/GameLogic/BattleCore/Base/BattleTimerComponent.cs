...
namespace GameLogic.Battle
{
    ...
    {
        [EntitySystem]
        private static void Awake(this BattleTimerComponent self)
        {
        }
        
       
        public static void FixUpdate(this BattleTimerComponent self)
        {
        ...
        private static long GetId(this BattleTimerComponent self)
        {
            return ++self.idGenerator;
        }

        private static long GetNow(this BattleTimerComponent self)
        {
            return self.Scene().GetComponent<BattleTime>().Now();
        }

        private static void Run(this BattleTimerComponent self, long timerId, ref TimerAction timerAction)
        {
        ...
        private static void AddTimer(this BattleTimerComponent self, long timerId, ref TimerAction timer)
        {
        ...
        public static bool Remove(this BattleTimerComponent self, ref long id)
        {
            long i = id;
            id = 0;
        ...
        private static bool Remove(this BattleTimerComponent self, long id)
        {
            if (id == 0)
            {
                return false;
        ...
        public static async ETTask WaitTillAsync(this BattleTimerComponent self, long tillTime, ETCancellationToken cancellationToken = null)
        {
            long timeNow = self.GetNow();
            if (timeNow >= tillTime)
            {
        ...
        public static async ETTask WaitFrameAsync(this BattleTimerComponent self, ETCancellationToken cancellationToken = null)
        {
            await self.WaitAsync(1, cancellationToken);
        }

        public static async ETTask WaitAsync(this BattleTimerComponent self, long time, ETCancellationToken cancellationToken = null)
        {
            if (time == 0)
            {
                return;
        ...
        public static long NewOnceTimer(this BattleTimerComponent self, long tillTime, int type, object args)
        {
            long timeNow = self.GetNow();
            if (tillTime < timeNow)
            {
        ...
        public static long NewFrameTimer(this BattleTimerComponent self, int type, object args)
        {
#if DOTNET
        ...
        /// 创建一个RepeatedTimer
        /// </summary>
        private static long NewRepeatedTimerInner(this BattleTimerComponent self, long time, int type, object args)
        {
#if DOTNET
            if (time < 100)
            {
        ...
        public static long NewRepeatedTimer(this BattleTimerComponent self, long time, int type, object args)
        {
            if (time < 100)
            {
    ...
    public class BattleTimerComponent: Entity, IAwake
    {
        /// <summary>
