...
{
    public class ClipTriggerType
    {
        [OptionSort(0)] [MenuName("时间触发")] public const int Time = 0;
        [MenuName("Clip事件触发")] public const int ClipEvent = 1;
    }

    public class SpellClipEvent
    {
        [OptionSort(0)]
        public const int None = 0;
        [MenuName("技能前摇开始")] public const int SkillPreStart = 1;
        [MenuName("技能前摇结束")] public const int SkillPreEnd = 2;
    }
